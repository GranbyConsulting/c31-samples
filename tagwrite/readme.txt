...
This folder contains a sample that uses a custom webpage
to write tag values from a form. The database should be
loaded into your target device, and the default.htm file
placed in the WEB directory on the memory card. The FTP
